--IF exists DROP SCHEMA MYSCHEMA2 CASCADE;
---DROP SCHEMA MYSCHEMA if exists CASCADE;
---DROP SCHEMA MYSCHEMA CASCADE IF EXISTS;
--DROP TABLE MYSCHEMA.country IF EXISTS;
--DROP SCHEMA MYSCHEMA IFEXISTS;
--DROP SCHEMA blax_blax CASCADE IF EXISTS;
--DROP SCHEMA MYSCHEMA CASCADE;

DROP SCHEMA MYSCHEMA CASCADE;
----------------DROP SCHEMA MYSCHEMA CASCADE;
--DROP SCHEMA MYSCHEMA CASCADE IF EXISTS;
--CREATE SCHEMA MYSCHEMA AUTHORIZATION DBA IF NOT EXISTS;
--SET AUTHORIZATION DBA;
--CREATE SCHEMA MYSCHEMA IF NOT EXISTS;
CREATE SCHEMA MYSCHEMA AUTHORIZATION DBA;

--if SELECT schema_name from INFORMATION_SCHEMA.SHEMATA where shema_name = 'MYSHEMA';
SET SCHEMA MYSCHEMA;
...
INSERT into country VALUES (1, 'United States ZZ');
INSERT into country VALUES (2, 'Russia XX');
